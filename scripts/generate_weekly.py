...
"""
Generate weeklyfeed.json for FaithLinks with robust scraping, CCC guidance,
and Sunday second-reading support.
...
HEADERS = {
    "User-Agent": "FaithLinksBot/1.2 (+repo automation)",
...
- If SECOND_READING_REF is provided (typical Sundays/solemnities), you MUST:
  ...
  2) Explicitly connect it within `theologicalSynthesis` and `exegesis` (tie thread across all readings).
